...
(function () {
  ...
  function applyTheme(t) {
    ...
    var sunSvgMob = sunSvg.replace('ico ico-sm', 'ico');
    var moonSvgMob = moonSvg.replace('ico ico-sm', 'ico');
    var dn = $('btn-daynight');
    if (dn) dn.innerHTML = light ? sunSvg : moonSvg;
    var dnm = $('btn-daynight-mob');
    if (dnm) {
      var dnmSvg = dnm.querySelector('svg');
      if (dnmSvg) dnmSvg.outerHTML = light ? sunSvgMob : moonSvgMob;
    }
  }
